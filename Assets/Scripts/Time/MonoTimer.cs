...
public class MonoTimer : MonoBehaviourExtended, IGameTimer 
{
  ...
  DataObject.DataActionf onTimeChange;
  DataObject.DataAction onTimeUp;
  ...
  public void SubscribeToTimeChange(DataObject.DataActionf action) 
	{
		onTimeChange += action;
	}

  public void UnsubscribeFromTimeChange(DataObject.DataActionf action) 
	{
		onTimeChange -= action;
	}

  public void SubscribeToTimeUp(DataObject.DataAction action) 
	{
		onTimeUp += action;
	}

  public void UnsubscribeFromTimeUp(DataObject.DataAction action) 
	{
		onTimeUp -= action;
	}
